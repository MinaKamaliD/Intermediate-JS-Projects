let productsContainr = document.querySelector(".container");
let productsArray = [
  { id: 1, title: "Sports Shoes", price: 53, img: "images/1.png" },
  { id: 2, title: "Women's Shoes", price: 81, img: "images/2.png" },
  { id: 3, title: "Boots", price: 34, img: "images/3.png" },
];

productsArray.forEach(function (product) {
  productsContainr.insertAdjacentHTML(
    "beforeend",
